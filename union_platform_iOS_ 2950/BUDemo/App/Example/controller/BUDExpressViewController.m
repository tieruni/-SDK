...
- (void)buildItemsData {
    ...
    BUDActionModel *feedCellItem_overSeas = [BUDActionModel plainTitleActionModel:@"Express Feed Picture OverSeas" type:BUDCellType_video action:^{
        __strong typeof(self) strongSelf = weakSelf;
        BUDExpressFeedViewController *vc = [BUDExpressFeedViewController new];
        BUDSlotViewModel *viewModel = [BUDSlotViewModel new];
        viewModel.slotID = express_feed_overSeas_ID;
        vc.viewModel = viewModel;
        [strongSelf.navigationController pushViewController:vc animated:YES];
    }];
    
    BUDActionModel *feedCellItem_Video_overSeas = [BUDActionModel plainTitleActionModel:@"Express Feed Video OverSeas" type:BUDCellType_video action:^{
        __strong typeof(self) strongSelf = weakSelf;
        BUDExpressFeedViewController *vc = [BUDExpressFeedViewController new];
        BUDSlotViewModel *viewModel = [BUDSlotViewModel new];
        viewModel.slotID = express_feed__video_overSeas_ID;
        vc.viewModel = viewModel;
        [strongSelf.navigationController pushViewController:vc animated:YES];
    }];
    ...
    BUDActionModel *drawCellItem_overSeas = [BUDActionModel plainTitleActionModel:@"Express Draw OverSeas" type:BUDCellType_video action:^{
        __strong typeof(self) strongSelf = weakSelf;
        BUDExpressDrawViewController *vc = [BUDExpressDrawViewController new];
        BUDSlotViewModel *viewModel = [BUDSlotViewModel new];
        viewModel.slotID = express_draw_overSeas_ID;
        vc.viewModel = viewModel;
        vc.modalPresentationStyle = UIModalPresentationFullScreen;
        [strongSelf presentViewController:vc animated:YES completion:nil];
    }];
    ...
    self.items = @[@[feedCellItem,feedCellItem_video,feedCellItem_overSeas,feedCellItem_Video_overSeas],@[drawCellItem,drawCellItem_overSeas],@[bannerCellItem,interCellItem,splashCell],@[fullScreenCellItem,rewardCellItem]].mutableCopy;
