...
- (void)viewDidLoad {
    ...
    self.sizeDcit = @{
                          ...
                          express_banner_ID_overSeas:  [NSValue valueWithCGSize:CGSizeMake(600, 500)]
                          };
    ...
    BUDSelcetedItem *item9 = [[BUDSelcetedItem alloc] initWithDict:@{@"slotID":express_banner_ID_overSeas,@"title":@"overSeas"}];
    NSArray *titlesAndIDS = @[@[item1,item2,item3],@[item4,item5,item6],@[item7,item8,item9]];
